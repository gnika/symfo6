 ...
 */
final class Version20220510204230 extends AbstractMigration
{
    ...
    public function up(Schema $schema): void
    {
        ...
        $this->addSql('ALTER TABLE site ADD user_id INT DEFAULT NULL, ADD logo VARCHAR(255) DEFAULT NULL');
    ...
    public function down(Schema $schema): void
    {
        ...
        $this->addSql('ALTER TABLE site DROP user_id, DROP logo');
    }
}
