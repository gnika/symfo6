...
/**
 * @extends ServiceEntityRepository<Parse1>
 *
 * @method Parse1|null find($id, $lockMode = null, $lockVersion = null)
 * @method Parse1|null findOneBy(array $criteria, array $orderBy = null)
 * @method Parse1[]    findAll()
 * @method Parse1[]    findBy(array $criteria, array $orderBy = null, $limit = null, $offset = null)
 */
class Parse1Repository extends ServiceEntityRepository
{
    public function __construct(ManagerRegistry $registry)
    {
        parent::__construct($registry, Parse1::class);
    }
     ...
     */
    public function add(Parse1 $entity, bool $flush = true): void
    {
     ...
     * @throws OptimisticLockException
     */
    public function remove(Parse1 $entity, bool $flush = true): void
    {
